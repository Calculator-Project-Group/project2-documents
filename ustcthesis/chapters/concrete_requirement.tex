...
{
\color{red}
\subsection{R.INSTANT.MESSAGE.USERS.006 好友清理}
\subsubsection{介绍}
用户可以在客户端将自己的好友删除
\subsubsection{输入}
\begin{itemize}
...
\end{itemize}
\subsubsection{处理}
客户端会向服务器发送请求，服务器会将对应的记录从数据库上删除
\subsubsection{输出}
\begin{itemize}
...
\subsection{R.INSTANT.MESSAGE.USERS.007 设置黑名单}
\subsubsection{介绍}
用户可以在客户端将其他用户加入黑名单，黑名单中的用户不能再申请好友，发起临时会话
\subsubsection{输入}
\begin{itemize}
	\item 对方用户ID
\end{itemize}
...
\subsection{R.INSTANT.MESSAGE.USERS.008 隐私设置}
\subsubsection{介绍}
